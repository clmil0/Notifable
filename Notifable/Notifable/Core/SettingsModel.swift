...
struct SettingsEntry: Identifiable, Hashable {
    ...
    static let all: [SettingsEntry] = [
        ...
        SettingsEntry(id: "icloud", title: "iCloud Mail",
                      keywords: ["icloud", "apple", "me.com", "mac.com", "imap",
                                 "contraseña específica", "correo"],
                      section: "Captura automática", destination: "icloud"),
